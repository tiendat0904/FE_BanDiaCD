...
@Component({
  selector: 'app-viewdanhsachchitiethoadonnhap',
  templateUrl: './viewdanhsachchitiethoadonnhap.component.html',
  styleUrls: ['./viewdanhsachchitiethoadonnhap.component.css']
})
export class ViewdanhsachchitiethoadonnhapComponent implements OnInit {
